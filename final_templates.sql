...
-- Uses PostgreSQL dollar-quoting for safe JSON handling
    ...
    "work": [
      {
        ...
        "startDate": "2021-03",
        "endDate": "Present",
        "summary": "Lead product strategy for Stripe Payments, serving 3M+ businesses globally. Launched 5 major features increasing merchant conversion by 23%. Manage a team of 8 engineers and 3 designers."
      },
      {
        "name": "Airbnb",
        ...
        "startDate": "2018-06",
        "endDate": "2021-02",
        "summary": "Owned the guest booking experience, optimizing the checkout flow that processes $50B+ annually. Reduced booking abandonment by 18% through A/B testing and user research."
      },
      {
        "name": "Google",
        ...
        "startDate": "2016-08",
        "endDate": "2018-05",
        "summary": "Part of Google APM program. Shipped features for Google Maps used by 1B+ monthly users. Conducted user research across 5 countries."
      }
    ],
    "education": [
      {
...
-- ============================================================================
-- INDUSTRY COVERAGE SUMMARY (5+ templates per industry)
-- ============================================================================
-- 
-- Technology (tech) - 8 templates:
--   Modern Professional, Executive Suite, Creative Portfolio, Academic Scholar,
--   Minimal ATS, Tech Innovator, Marketing Pro, Classic Business
--
-- Business & Finance (business) - 8 templates:
--   Modern Professional, Executive Suite, Creative Portfolio, Minimal ATS,
--   Legal Excellence, Classic Business, Marketing Pro, Healthcare Professional
--
-- Healthcare (healthcare) - 6 templates:
--   Modern Professional, Executive Suite, Academic Scholar, Minimal ATS,
--   Healthcare Professional, Classic Business
--
-- Creative & Design (creative) - 6 templates:
--   Modern Professional, Creative Portfolio, Minimal ATS, Tech Innovator,
--   Marketing Pro, Executive Suite
--
-- Marketing & Sales (marketing) - 6 templates:
--   Modern Professional, Executive Suite, Creative Portfolio, Minimal ATS,
--   Classic Business, Marketing Pro
--
-- Education (education) - 8 templates:
--   Modern Professional, Executive Suite, Academic Scholar, Minimal ATS,
--   Healthcare Professional, Legal Excellence, Classic Business, Marketing Pro
--
-- Legal (legal) - 6 templates:
--   Modern Professional, Executive Suite, Academic Scholar, Minimal ATS,
--   Legal Excellence, Classic Business
--
-- Other (other) - 8 templates:
--   Modern Professional, Executive Suite, Creative Portfolio, Academic Scholar,
--   Minimal ATS, Healthcare Professional, Legal Excellence, Classic Business,
--   Marketing Pro
--
-- ============================================================================
-- LAYOUT SWITCHING
-- ============================================================================
-- Users can switch between single-column and two-column layouts in the editor
